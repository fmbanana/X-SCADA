...
page.createImage({id: "image_2", securityKey: "", baseUrl: "img/0000011306_Xisom_FactoryControlSystem_6.svg", tag: "", customRepository: false, customUrlTag: "", visible: true, x: 110, y: 190, width: 572.285, height: 395.049, imageWidth: 100, imageHeight: 69, angle: 0, opacity: 1, animated: false, flipX: false, flipY: false, tooltip: "", animatableImage: false });
page.createImage({id: "image_1", securityKey: "", baseUrl: "img/0000007833_X-SCADA_machine43.svg", tag: "", customRepository: false, customUrlTag: "", visible: true, x: 389.785, y: 300, width: 65.384, height: 109.992, imageWidth: 76, imageHeight: 128, angle: 0, opacity: 1, animated: false, flipX: false, flipY: false, tooltip: "", animatableImage: false });
...
page.createActions({id: "label_2", plans: [{type: "PageClick", button: 0, mode: "Replace", window: "", options: "height=600,width=800", page: "index" }] });
...
document.body.addEventListener('keydown', function(e){page.keypressPage(e,'index','sub2')});
